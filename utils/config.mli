...
val cmt_magic_number: string
        (* Magic number for compiled interface files *)
val cmg_magic_number: string
        (* Magic number for location tables *)
...
val use_ocp_watcher: bool ref
        (* Whether compilation steps should be recorded through ocp-watcher *)
