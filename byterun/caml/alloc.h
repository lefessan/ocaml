...
CAMLextern value caml_alloc_with_profinfo (mlsize_t, tag_t, uintnat);
CAMLextern value caml_alloc_small_with_my_or_given_profinfo (
  mlsize_t, tag_t, uintnat);
CAMLextern value caml_alloc_small_with_profinfo (mlsize_t, tag_t, uintnat);
CAMLextern value caml_copy_string_with_profinfo (char const *,uintnat);
CAMLextern value caml_alloc_string_with_profinfo (mlsize_t,uintnat);
