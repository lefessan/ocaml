...
enum instructions {
  ...
  GRAB_WITH_LOCID,
  CLOSURE_WITH_LOCID,
  CLOSUREREC_WITH_LOCID,
  MAKEBLOCK_WITH_LOCID,
  MAKEBLOCK1_WITH_LOCID,
  MAKEBLOCK2_WITH_LOCID,
  MAKEBLOCK3_WITH_LOCID,
  MAKEFLOATBLOCK_WITH_LOCID,
  GETFLOATFIELD_WITH_LOCID,
  C_CALL1_WITH_LOCID,
  C_CALL2_WITH_LOCID,
  C_CALL3_WITH_LOCID,
  C_CALL4_WITH_LOCID,
