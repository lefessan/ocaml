...
DECLARE_HOOK1(caml_set_minor_heap_size_hook, intnat bsz);
DECLARE_HOOK1(caml_empty_minor_heap_hook,);

DECLARE_HOOK1(caml_do_compaction_hook, intnat position);
...
DECLARE_HOOK1(caml_garbage_collection_hook, intnat position);
