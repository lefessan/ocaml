...
#else
    | Tstr_type [{ typ_id; typ_type; }] ->
        Sig_type (typ_id, typ_type, Trec_not) :: acc
    | Tstr_type ({ typ_id; typ_type } :: decls) ->
...
let apply_internal_interface_rewriters source_file intf =
  Ocputils.fold_rewriters !internal_interface_rewriters source_file intf
let apply_internal_implementation_rewriters source_file (impl, coerce) =
  Ocputils.fold_rewriters !internal_implementation_rewriters source_file impl, coerce
