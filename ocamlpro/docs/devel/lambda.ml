...
(* "%revapply" = "|>", two arguments *)
  | Pdirapply of Location.t
(* "%dirapply" = "@@", two arguments *)

  | Ploc of loc_kind
(* __LOC__ directives, and so on. zero argument.*)

  | Pgetglobal of Ident.t
(* Read a global identifier (of this module), zero argument *)
  | Psetglobal of Ident.t
(* Save a global identifier (of this module), one argument *)

  | Pmakeblock of int * mutable_flag
(* [Pmakeblock(tag, mut) Creates a block with tag [tag] and mutability [mut].
   The arguments decide of the size of the block. *)
